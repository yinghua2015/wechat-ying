...
<div>
  <el-tabs v-model="activeName2" type="card" >
    <el-tab-pane label="日志管理" name="first">
...
export default {
  ...
  methods: {
    ...
    add_time2(post_data) {
      ...
      this.$http
        .post(
          "http://trendapi.show-fund.com/add_time_label/",
          {
            coin_type: post_data.coin_type,
    ...
    submitForm2() {
      ...
      var post_data = {
        mark_time: this.markTime,
        coin_type: this.$store.getters.typeNew,
        trend_type: this.$store.getters.typeNew,
        label_content: this.tags,
        user_data: this.yAxi,
        priority: 0
      };
