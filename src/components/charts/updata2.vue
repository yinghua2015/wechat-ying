...
<div>
  <el-tabs v-model="activeName2" type="card" >
    <div class="quill-wrap" v-show="iscard">
    <div>日志时间点：{{timesBengin}}</div>
      <el-input class="elinp" v-model="topic_content" placeholder="请输入标题" label="标题："></el-input>
      <div class="inp_radio">
    ...
    <el-tab-pane label="标签管理" name="second">
      <div>
        <div>标签时间点：{{timesBengin}}</div>
        <el-input type="textarea"  v-model="tags" placeholder="111111"></el-input>
...
export default {
  ...
  mounted() {
    ...
    this.timeer();
    this.timeStart = this.timesBengin;
  ...
  methods: {
    ...
    add_time(post_data) {
      ...
      this.$http
        .post(
          "http://trendapi.show-fund.com/add_time_mark/",
          {
    ...
    add_time2(post_data) {
      console.log(post_data + "-----add-times2");
      console.log(this.yAxi)
      // this.content = post_data.mark_content;
      const _this = this;
      this.$http
        .post(
          "http://trendapi.show-fund.com/update_time_label/",
          {
            coin_type: post_data.coin_type,
            label_content: this.tags,
            mark_time: post_data.mark_time,
            trend_type: post_data.trend_type,
            record_id:this.recordlabel,
            user_data:this.yAxi,
            priority: 0
          },
          {
