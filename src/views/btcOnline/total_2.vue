<template>
  <div id="app">
   ...
   <div>Coinmarketcap统计的除比特币外，数字货币的总市值及交易量数据。当前某币种总市值=当前流通总量*当前价格。数据来源：//coinmarketcap.com/zh/charts/</div>
  </div>
</template>
<style scoped>
.form-page {
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      $.ajax({
        type: "post",
        data: {
          url: "http://graphs2.coinmarketcap.com/global/marketcap-altcoin/"
        },
        url: urt_pro,
        dataType: "json",
        beforeSend: function() {
