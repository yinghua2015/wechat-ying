<template>
  <div id="app">
    ...
    <div class="textP" style="text-align:center">
      <p>OKEx交易所内SHOW多空比数据。</p>
      <p>秀多空比：（买盘200档总市值-卖盘200档总市值）/ 卖盘200档总市值 × 100%</p>
      <p>买盘200档总市值：买盘200档占用的资金量，即各个价格档的单位：SHOW*各个档的价格，计算出累计金额;</p>
      <p>卖盘200档总市值：卖盘200档占用的资金量，卖盘200档总show币数量*卖一价</p>
    </div>
...
export default {
  ...
  mounted() {
    ...
    this.$http
      .get(
        `//trendapi.show-fund.com/show_okex_depth_askbid_rate/0/${timestamp}`
      )
      .then(function(res) {
  ...
  methods: {
    ...
    allData(kv, index) {
      ...
      if (index == "0") {
        ...
        this.$http
          .get(
            `//trendapi.show-fund.com/show_okex_tx_exchange_rate/0/${timestamp}/10000000/1/`
          )
          .then(function(res) {
            var names = [
              "SHOW多空比",
