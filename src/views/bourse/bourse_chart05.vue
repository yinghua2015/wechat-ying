<template>
  <div id="app">
    ...
    <div class="p-txt">统计了包括okex、digifinex、hcoin、fcoin、cex、bigone等交易所内的秀币总额。</div>
<div v-show="isList2">
        <el-collapse>
...
export default {
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      var urt_pro =
        "http://trendapi.show-fund.com/show_ex_hold/all/1515395432000/" + endTime;
