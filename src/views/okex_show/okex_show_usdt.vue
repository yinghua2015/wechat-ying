...
export default {
  ...
  watch: {
    ...
    //   if (val === "Okex") {
    //     var localcontent = "usdt-out-ok";
    //     this.typeNameNew = "usdt-out-ok";
    //     this.$store.commit("typeNewAll",this.typeNameNew);
    //     this.exchange();
    //   } else if (val === "Huobi") {
    //     var localcontent = "usdt-out-hb";
    //     this.typeNameNew = "usdt-out-hb";
    //     this.$store.commit("typeNewAll",this.typeNameNew);
    //     this.exchange();
    //   } else if (val === "Bitfinex") {
    //     var localcontent = "usdt-out-btf";
    //     this.typeNameNew = "usdt-out-btf";
    //     this.$store.commit("typeNewAll",this.typeNameNew);
    //     this.exchange();
    //   } else if (val === "Binance") {
    //     var localcontent = "usdt-out-bin";
    //     this.typeNameNew = "usdt-out-bin";
    //     this.$store.commit("typeNewAll",this.typeNameNew);
    //     this.exchange();
    //   } else if (val === "all") {
    //     var localcontent = "usdt-out-all";
    //     this.typeNameNew = "usdt-out-all";
    //     this.$store.commit("typeNewAll",this.typeNameNew);
    //     this.exchange();
    //   }
    // }
  ...
  mounted() {
    ...
    this.typeNameNew = "okex-show-usdt";
    this.$store.commit("typeNewAll", this.typeNameNew);
    this.exchange();
  },
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      var endTime = Date.parse(new Date());
      var urt_dev = "/goods/usdt-out";
      // var urt_pro =
      //   "http://trendapi.show-fund.com/coinmarketpricebytype/show/usd/0/" +endTime
        // endTime +
        // "/" +
        // this.$store.getters.times;
        var urt_pro ='';
      ...
      if(this.$store.getters.times == 1){
        urt_pro = "http://trendapi.show-fund.com/coinmarketpricebytype/show/usd/day/0/" +endTime;
        //return urt_pro;
      }else if(this.$store.getters.times == 0){
        urt_pro = "http://trendapi.show-fund.com/coinmarketpricebytype/show/usd/hour/0/" +endTime;
         //return urt_pro;
      }
      console.log(urt_pro)
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          this.stockChart = new Highcharts.stockChart("container", {
            ...
            title: {
              text: `${_this.txt_name}秀币对USDT价格走势图`
            },
            annotations: [
              {
                labelOptions: {
            ...
            tooltip: {
              ...
              formatter: function() {
                ...
                if (_this.$store.getters.times == 1) {
                  return "<b>" + content_hour + "</b> :  <b>" + Number(this.y).toFixed(6) + "</b>"+' $';
                } else if (_this.$store.getters.times == 0) {
                  return "<b>" + content + "</b> :  <b>" + Number(this.y).toFixed(6) + "</b>"+' $';
                }
              }
            },
            xAxis: {
