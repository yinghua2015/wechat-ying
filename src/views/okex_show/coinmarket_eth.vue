<template>
  <div id="app">
    ...
    <div class="p-txt">数据来源：//coinmarketcap.com/currencies/ethereum/</div>
    <div v-show="isList2">
      <el-collapse>
        <el-collapse-item
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      if (this.$store.getters.times == 1) {
        urt_pro =
          "http://trendapi.show-fund.com/coinmarketpricebytype/ethereum/usd/day/0/" +
          endTime;
        //return urt_pro;
      } else if (this.$store.getters.times == 0) {
        urt_pro =
          "http://trendapi.show-fund.com/coinmarketpricebytype/ethereum/usd/hour/0/" +
          endTime;
        //return urt_pro;
      }
      console.log(urt_pro);
