<template>
  <div id="app">
    ...
    <div class="p-txt">数据来源：//coinmarketcap.com/currencies/bitcoin/</div>
    <!-- <div class="p-txt">抓取coinmarketcap上BTC每小时的价格数据</div> -->
    <div v-show="isList2">
      <el-collapse>
        <el-collapse-item
...
export default {
  ...
  data() {
    return {
      txt_name:"",
      isday:'抓取coinmarketcap上BTC每小时的价格数据',
      logsTag: "   日志：",
      yAxi: "",
      tagTxt: "标签：",
      tags: "",
  ...
  mounted() {
    ...
    this.typeNameNew = "okex-show-btc";
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      if(this.$store.getters.times == 1){
        urt_pro = "http://trendapi.show-fund.com/coinmarketpricebytype/bitcoin/usd/day/0/" +endTime;
        //return urt_pro;
      }else if(this.$store.getters.times == 0){
        urt_pro = "http://trendapi.show-fund.com/coinmarketpricebytype/bitcoin/usd/hour/0/" +endTime;
         //return urt_pro;
      }
      console.log(urt_pro)
      // "/" + this.$store.getters.times;
