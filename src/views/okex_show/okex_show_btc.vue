  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      if(this.$store.getters.times == 1){
        urt_pro = "http://trendapi.show-fund.com/coinmarketpricebytype/show/btc/day/0/" +endTime;
        //return urt_pro;
      }else if(this.$store.getters.times == 0){
        urt_pro = "http://trendapi.show-fund.com/coinmarketpricebytype/show/btc/hour/0/" +endTime;
         //return urt_pro;
      }
      console.log(urt_pro)
      // "/" + this.$store.getters.times;
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          this.stockChart = new Highcharts.stockChart("container", {
            ...
            title: {
              text: `${_this.txt_name}秀币对比特币价格走势图`
            },
            annotations: [
              {
                labelOptions: {
