<template>
  <div id="app">
    ...
    <div class="p-txt">
      比特币区块链上，每日比特币转账的总数额，单位是BTC。A地址转给B地址X个比特币，即转账比特币数额为X个BTC。每日所有转账数额之和即每日比特币转账的总数额。
    </div>
<div v-show="isList2">
        <el-collapse>
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var ohlc = [],
            ...
            volume = [],
            _flag = [],
            dataLength = data.btc_day_tx_amount.length,
