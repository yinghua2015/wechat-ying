<template>
  <div id="app">
    ...
    <div class="p-txt">每日发生ETH交易的地址的总数。例如今日A地址与B地址发生过ETH交易，则在今日这两个地址都是ETH活跃地址。</div>
<div v-show="isList2">
        <el-collapse>
...
export default {
  ...
  data() {
    return {
      ...
      isList: false,
      activeNames: ["1"],
      typeNameNew: "eth-active-address",
      htmlall: "",
      markcontent: [],
      flagsName: [],
      stockChart: null,
  ...
  mounted() {
    ...
    this.typeNameNew = "eth-active-address"
    this.$store.commit("typeNewAll",this.typeNameNew);
    this.exchange();
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      var urt_pro = "http://trendapi.show-fund.com/eth_day_active_address/";
