<template>
  <div id="app">
    ...
    <div class="p-txt">
      每日发生BTC交易的地址的总数。例如今日A地址与B地址发生过BTC交易，则在今日这两个地址都是BTC活跃地址。
    </div>
<div v-show="isList2">
        <el-collapse>
...
export default {
  ...
  data() {
    return {
      ...
      isList: false,
      activeNames: ["1"],
      typeNameNew: "btc-active-address",
      htmlall: "",
      markcontent: [],
      flagsName: [],
      stockChart: null,
  ...
  mounted() {
    ...
    this.typeNameNew = "btc-active-address"
    this.$store.commit("typeNewAll",this.typeNameNew);
    this.exchange();
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      var urt_pro = "http://trendapi.show-fund.com/btc_day_active_address/";
