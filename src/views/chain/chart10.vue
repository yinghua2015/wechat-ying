<template>
  <div id="app">
    ...
    <div class="p-txt">首次发生BTC交易的地址数（不包含从未发生过BTC交易的地址）。</div>
<div v-show="isList2">
        <el-collapse>
...
export default {
  ...
  mounted() {
    ...
    this.typeNameNew = "btc-new-address"
    this.$store.commit("typeNewAll",this.typeNameNew);
    this.exchange();
  ...
  methods: {
    ...
    createChart(flag, flag2) {
      ...
      var urt_pro = "http://trendapi.show-fund.com/btc_day_birth_address/";
