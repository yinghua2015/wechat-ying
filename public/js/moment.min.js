...
function() {
    ...
    de = /^\/?Date\((\-?\d+)/i;
    a.createFromInputFallback = u("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to //github.com/moment/moment/issues/1407 for more info.",
    function(a) {
    ...
    var ee = M("FullYear", !0);
    a.ISO_8601 = function() {};
    var fe = u("moment().min is deprecated, use moment.max instead. //github.com/moment/moment/issues/1548",
    function() {
        var a = Ka.apply(null, arguments);
        return this.isValid() && a.isValid() ? this > a ? this: a: l()
    }),
    ge = u("moment().max is deprecated, use moment.min instead. //github.com/moment/moment/issues/1548",
    function() {
        var a = Ka.apply(null, arguments);
    ...
    Ce.zone = u("moment().zone is deprecated, use moment().utcOffset instead. //github.com/moment/moment/issues/1779", Va);
    var De = Ce,
    Ee = {
        sameDay: "[Today at] LT",
